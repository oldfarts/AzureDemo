...
#Author - maintainer
MAINTAINER Author Name jarvas77@hotmail.com
...
RUN echo 'deb http://ppa.launchpad.net/webupd8team/java/ubuntu trusty main' >> $
    ...
    apt-get update && \
    echo oracle-java${JAVA_VER}-installer shared/accepted-oracle-license-v1-1 s$
    apt-get install -y --force-yes --no-install-recommends oracle-java${JAVA_VE$
    apt-get clean && \
